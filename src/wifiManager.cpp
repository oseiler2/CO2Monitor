...
#define HTTP_PORT 80
  ...
  void setupWifiManager(ESPAsync_WiFiManager* wifiManager) {
    ...
    co2YellowThresholdParam = new ESPAsync_WMParameter("co2YellowThreshold", "CO2 Yellow threshold ", co2YellowThreshold, 5, "config.co2YellowThreshold");
    co2RedThresholdParam = new ESPAsync_WMParameter("co2RedThreshold", "CO2 Red threshold", co2RedThreshold, 5, "config.co2RedThreshold");
    co2DarkRedThresholdParam = new ESPAsync_WMParameter("co2DarkRedThreshold", "CO2 Dark red threshold", co2DarkRedThreshold, 5, "config.co2DarkRedThreshold");
    iaqYellowThresholdParam = new ESPAsync_WMParameter("iaqYellowThreshold", "IAQ Yellow threshold ", iaqYellowThreshold, 5, "config.iaqYellowThreshold");
    iaqRedThresholdParam = new ESPAsync_WMParameter("iaqRedThreshold", "IAQ Red threshold", iaqRedThreshold, 5, "config.iaqRedThreshold");
    iaqDarkRedThresholdParam = new ESPAsync_WMParameter("iaqDarkRedThreshold", "IAQ Dark red threshold", iaqDarkRedThreshold, 5, "config.iaqDarkRedThreshold");
